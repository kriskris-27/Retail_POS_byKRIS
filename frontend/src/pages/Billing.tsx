      ...
      <div className="w-full md:w-2/5 lg:w-1/3 p-3 md:p-4 overflow-auto bg-gray-100">
        <div className="bg-white rounded-2xl shadow-md p-4 h-full flex flex-col">
          ...
          <div className="border-t border-gray-200 pt-3 mt-auto space-y-3">
            ...
            <div className="flex-grow overflow-y-auto mb-4">
              {billItems.length === 0 ? (
                <div className="text-center py-8 text-gray-500">
                  ...
                  <p className="text-xs mt-1">Add products to create a bill</p>
                </div>
              ) : (
                <div className="space-y-2">
                  {billItems.map((item) => (
                    <div key={item.product} className="border border-gray-100 rounded-lg p-3 flex flex-wrap items-center bg-gray-50 hover:bg-gray-100 transition-colors">
                      <div className="w-full sm:w-1/2 flex flex-col mb-2 sm:mb-0">
                        <span className="font-medium text-gray-800">{item.name}</span>
                        <span className="text-sm text-gray-500">₹{item.price} per unit</span>
                      </div>
                      <div className="w-1/2 sm:w-1/4">
                        <div className="flex items-center">
                          <button 
                            onClick={() => decrementQuantity(item.product)}
                            className="w-8 h-8 flex items-center justify-center bg-gray-200 hover:bg-gray-300 rounded-full text-gray-700 transition-colors"
                          >
            ...
            {/* Border line before payment section */}
            <div className="border-t border-gray-200 pt-3 mt-auto space-y-3">
            {/* Payment Method */}
            <div>
